...
Revision ID: b970ca99e30c
Revises: 
Create Date: 2026-02-25 15:11:38.323349
...
def upgrade() -> None:
    ...
    sa.Column('students_count', sa.Integer(), server_default=sa.text('0'), nullable=False),
